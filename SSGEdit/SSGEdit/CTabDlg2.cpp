...
BOOL CTabDlg2::OnInitDialog()
{
	...
	m_Grid_Beam.SetItemText(0, 48, _T("8"));
	m_Grid_Beam.SetItemText(0, 49, _T("轴力内力调整系数"));
	m_Grid_Beam.SetItemText(0, 50, _T("弯矩内力调整系数"));
	m_Grid_Beam.SetItemText(0, 51, _T("剪力内力调整系数"));
	m_Grid_Beam.SetItemText(0, 52, _T("附加材料"));
	m_Grid_Beam.SetItemText(0, 53, _T("1端半刚性属性"));
	m_Grid_Beam.SetItemText(0, 54, _T("2端半刚性属性"));
	m_Grid_Beam.SetItemText(0, 55, _T("剪切属性"));
	m_Grid_Beam.SetItemText(0, 56, _T("构件跨度"));
	m_Grid_Beam.SetItemText(0, 57, _T("0"));
	m_Grid_Beam.SetItemText(0, 58, _T("0"));
	m_Grid_Beam.SetItemText(0, 59, _T("0"));
	m_Grid_Beam.SetItemText(0, 60, _T("0"));
	m_Grid_Beam.SetItemText(0, 61, _T("0"));
	//设置列宽，并将部分列隐藏
	...
	m_Grid_Beam.SetColumnWidth(48, 0);
